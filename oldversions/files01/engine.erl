...
start(FILE_NAME)->
	...
	start(FILE, 100, 88, 600, 0.05, 0.0006, 0.5, 0.9995, 0.1, 0.1, 0.3).%TODO set those
start(FILE, MAX_NODES, MAX_AGE, LAMBDA, MOVE_K, MOVE_N, ALPHA, D, FINAL_ERROR, FINAL_DELTA_ERROR,
	  FINAL_DELTA_ERROR_DECAY)->
	start(FILE, 100, 88, 600, 0.05, 0.0006, 0.5, 0.9995, 3, 5, 0, 0, FINAL_ERROR, FINAL_DELTA_ERROR,
		    FINAL_DELTA_ERROR_DECAY,err_man, win_man, [], 0, 0).
start(FILE, MAX_NODES, MAX_AGE, LAMBDA, MOVE_K, MOVE_N, ALPHA, D, M, N, 0, 0, FINAL_ERROR, FINAL_DELTA_ERROR, 
...
%% 0. 	Create max			(this has to create a MinManager)
	...
	start(FILE, MAX_NODES, MAX_AGE, LAMBDA, MOVE_K, MOVE_N, ALPHA, D, M, N,
						  FINAL_ERROR, FINAL_DELTA_ERROR, FINAL_DELTA_ERROR_DECAY, 
				  0, 2, ERR_MAN, WIN_MAN, LOST_NODE_LIST, LAST_ERROR, DELTA_ERROR);
...
start(FILE, MAX_NODES, MAX_AGE, LAMBDA, MOVE_K, MOVE_N, ALPHA, D, M, N, ITERATION, NUMBER_OF_NODES,
...
%% 
	...
	if
		REM_IT == 0 ->
			...
			checkMessages(FILE, MAX_NODES, MAX_AGE, LAMBDA, MOVE_K, MOVE_N, ALPHA, D, M, N,
						  FINAL_ERROR, FINAL_DELTA_ERROR, FINAL_DELTA_ERROR_DECAY, 
				  ITERATION+1, NUMBER_OF_NODES, ERR_MAN, WIN_MAN, LOST_NODE_LIST, ERROR,
		...
		true ->
			ERR_MAN ! {decrease_error, self()},
				...
				checkMessages(FILE, MAX_NODES, MAX_AGE, LAMBDA, MOVE_K, MOVE_N, ALPHA, D, M, N,
				  FINAL_ERROR, FINAL_DELTA_ERROR, FINAL_DELTA_ERROR_DECAY, 
				  ITERATION+1, NUMBER_OF_NODES, ERR_MAN, WIN_MAN, LOST_NODE_LIST, LAST_ERROR,
				  DELTA_ERROR)
	end
